...
import Adapter.ExamTeacherClassesAdapter;
...
public class ExamTeacherClassesActivity extends AppCompatActivity {
    private RecyclerView recyclerView;
    private ExamTeacherClassesAdapter bAdapter;
    private Api api;
    private List<ClassSubjectClass> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        bAdapter = new ExamTeacherClassesAdapter(getApplicationContext(), list);
